...
const StudySessionRequest = () => {
  const sessions = useLoaderData();

  return (
    <div className="">
      <h1>Your total Session: {sessions.length}</h1>

      <div className="">
        <div className="grid lg:grid-cols-2 gap-2">
          {sessions.map((session) => (
            <div className="" key={session._id}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-1">
                ...
                <span className="flex items-center space-x-2">
                  ...
                  <span className="">
                    <button className="btn">Modify and Re-Request</button>
                  </span>
                </span>
              </div>
            </div>
...
export default StudySessionRequest;
